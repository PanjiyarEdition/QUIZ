    ...
    <div class="bg1">
        <div class="row">
            ...
            <div class="col-md-6 panel" style="background-image:url(image/bg1.jpg); min-height:430px;">
                <h2 align="center" style="font-family:'typo'; color:#000066">FEEDBACK FORM</h2>
                <div style="font-size:14px">
                    <?php if(@$_GET['q'])echo '<span style="font-size:18px;"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;'.@$_GET['q'].'</span>';
else
{echo'
 you can directly submit your feedback by filling the enteries below:-</p>
...
<input type="submit" name="submit" value="Submit" class="btn btn-primary" />
    ...
    <!--container end-->
        ...
        <div class="col-md-3 box">
            <a href="https://www.linkedin.com/in/jigarpanjiyar/" target="_blank">About Us</a>
        </div>
        <div class="col-md-3 box">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <img src="image/banner.jpg" width=100 height=100 alt="banner" class="img-rounded">
                        </div>
                        <div class="col-md-5">
                            <a href="https://www.linkedin.com/in/jigarpanjiyar/"
                                style="color:#202020; font-family:'typo' ; font-size:18px"
                                title="Find on Facebook">Panjiyar_Edition</a>
                            <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+919876543210
                            </h4>
                            <h4 style="font-family:'typo' ">panjiyaredition@gmail.com</h4>
                            <h4 style="font-family:'typo' ">XYX College
                            </h4>
                        </div>
                    </div>
                    </p>
